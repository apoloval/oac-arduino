...
OutputDir=./installer
OutputBaseFilename=oac_arduino-{#MyAppVersion}
Compression=lzma
...
[Files]
Source: "libraries/oacbtn/*"; DestDir: "{app}/libraries/oacbtn"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "libraries/oacexp/*"; DestDir: "{app}/libraries/oacexp"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "libraries/oacio/*"; DestDir: "{app}/libraries/oacio"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "libraries/oackb/*"; DestDir: "{app}/libraries/oackb"; Flags: ignoreversion recursesubdirs createallsubdirs
